<?php require_once('../../../Connections/FADA_prueba.php'); ?>
...
if (!empty($_SERVER['QUERY_STRING'])) {
  ...
  foreach ($params as $param) {
    if (
      stristr($param, "pageNum_o_elo") == false &&
  ...
  <table border="0" align="center" cellspacing="0">
    ...
    <?php do { ?>
      <tr>
        ...
        <td><a href="3_3_jugador_personal_datos.php?ID_Fada=<?php echo $row_o_elo['ID_Fada']; ?>"><?php echo htmlentities($row_o_elo['Apellidos_Nombre']); ?></a></td>
